...
<body>
    ...
    <section class="ContentPage full-width">
		...
		<div class="NavLateralDivider">
		 <form  class="login active" method="post" action="hist_fac.php" >
        <table border="0">
          <tr>
		     <td  width="10%"><input type="date"  name="date" id="fecha"></td>
             <td width="10%"><input type="date"  name="date1" id="fecha2"  width="10%"></td>
            
            <td><input type="submit" value="  Consultar  " onclick= "ClosingVar= false" /></td>
          </tr>
        </table>
      </form>
		...
		<br>
		 <?php
			if (isset($_POST['date'])and isset($_POST['date1'])) { 
			$_SESSION["date"]=$_POST['date'];
			$_SESSION["date1"]=$_POST['date1'];
			
	?>
    <article id="contenido_tran_his"></article>
    <?php
}
?>
		<!-- Your code here -->
