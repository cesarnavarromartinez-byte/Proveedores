...
$sql = " select SUM(estado)Impacto from SIMOP..documentos_web_ped where  MONTH( fecha)=MONTH(GETDATE()) and usuario='".$_SESSION["Usuario"]."' and  year( fecha)= year (GETDATE()) and estado='1'";
$impac=  sqlsrv_query( $link, $sql );
$impacto  = sqlsrv_fetch_array( $impac, SQLSRV_FETCH_ASSOC);
?>
<html lang="es">
<head>
	<meta charset="UTF-8">
                ...
                <ul class="full-width">
                    ...
                    <li>
                        ...
                        <ul class="full-width">
							...
							<li><a href="simple.php" class="waves-effect waves-light">Total Transferencias</a></li>
                        </ul>
                    </li>
                    <li class="NavLateralDivider"></li>
                    <li>
               ...
               <!--<li style="padding:0 5px;">User Name</li>-->
                ...
                <li>
                    <a href="#" class="tooltipped waves-effect waves-light btn-Notification" data-position="bottom" data-delay="50" data-tooltip="Notificaciones">
                        ...
                        <span class="ContentPage-Nav-indicator bg-danger">0</span>
                    </a>
                </li>
            </ul>   
        </div>
                ...
                <div class="full-width center-align" style="margin: 40px 0;">
                    <div class="tile">
                        ...
                        <div class="tile-caption">
                            <span class="center-align"><?php echo $impacto["Impacto"];?></span>
                            <p class="center-align">Clientes impactados mes</p>   
                        </div>
                        <a href="#" class="tile-link waves-effect waves-light">Detalles &nbsp; <i class="zmdi zmdi-caret-right-circle"></i></a>
                    </div>
                    <div class="tile">
                        <div class="tile-icon"><i class="zmdi zmdi-shopping-cart"></i></div>
                        <div class="tile-caption">
                            <span class="center-align">0</span>
                            <p class="center-align">Ventas del mes</p>   
                        </div>
                        <a href="#" class="tile-link waves-effect waves-light">Detalles &nbsp; <i class="zmdi zmdi-caret-right-circle"></i></a>
                    </div>
                    <div class="tile">
                        ...
                        <div class="tile-caption">
                            <span class="center-align">0</span>
                            <p class="center-align">Transferencias no exitosas</p>   
                        </div>
                        <a href="#" class="tile-link waves-effect waves-light">Detalles &nbsp; <i class="zmdi zmdi-caret-right-circle"></i></a>
                    </div>
                </div>   
            ...
            <article class="col s12">
                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h5 class="timeline-title">Twiter</h5>
                                <p><small class="text-muted"><i class="zmdi zmdi-time"></i> 11 horas ago via Twitter</small></p>
                            </div>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                ...
                                <p><small class="text-muted"><i class="zmdi zmdi-time"></i> 10 horas ago via Facebook</small></p>
                            </div>
                            <div class="timeline-body">
                                <p>.</p>
                            </div>
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h5 class="timeline-title success">Whatsapp</h5>
                                <p><small class="text-muted"><i class="zmdi zmdi-time"></i> 9 horas ago via Whatsapp</small></p>
                            </div>
                            <div class="timeline-body">
                                <p></p>
                            </div>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h5 class="timeline-title">Pinterest</h5>
                                <p><small class="text-muted"><i class="zmdi zmdi-time"></i> 8 horas ago via Pinterest</small></p>
                            </div>
                            <div class="timeline-body">
                                <p></p>
                            </div>
