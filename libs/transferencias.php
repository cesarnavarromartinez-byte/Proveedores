...
where h.nit=t.nit and l.codigo=r.codigo and h.bodega='1' and h.sw=l.sw and h.numero=l.numero and w.numero=h.numero  and  w.usuario='".$_SESSION["Usuario"]."' and year (h.fecha)=year(GETDATE()) and MONTH( h.fecha)=MONTH(GETDATE( )) 
