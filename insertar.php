...
$nit=$_SESSION["user"];
	...
	$row=sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC);
			...
			//---------------------------------------------------------------------------------------------------------------------------------------------------------------
			$sql5 = "select top 1 Numero+1 as conse  from documentos_ped_historia where bodega=1 AND sw=1 order by numero desc";
			...
			if(isset($_SESSION['carro'])){
				...
				values (1,1,'".$consecutivo."','".$_SESSION["user"]."','".$_SESSION["vendedor"]."',CONVERT(datetime, DATEDIFF(d, 0, getdate()), 102),'".$_SESSION["condicion"]."','2','".$_SESSION["desc_pie"]."','".$_SESSION["totalcoste"]."',getdate(),'0','//TRANSFERENCIA VIA WEB 2.0 - ".$comentario."//','".$_SESSION["Usuario"]."','PC_WEB','1','4',getdate()+1,'0','".$_SESSION["lista"]."','0','0' )";
				...
				values (1,1,'".$consecutivo."','".$_SESSION["user"]."','".$_SESSION["vendedor"]."',CONVERT(datetime, DATEDIFF(d, 0, getdate()), 102),'".$_SESSION["condicion"]."','2','".$_SESSION["totalcoste"]."',getdate(),'0','//TRANSFERENCIA VIA WEB 2.0 - ".$comentario."//','".$_SESSION["Usuario"]."','PC_WEB','1','0','0','0' )";
				$smtp= sqlsrv_query( $link, $sql6 );	
				//web
				$sql7 = "insert into documentos_ped_web (sw,numero,usuario)
				values (1,'".$consecutivo."','".$_SESSION["Usuario"]."')";
				...
				foreach($_SESSION['carro'] as $id => $x){
					...
					VALUES(1,1,'".$consecutivo."','".$id."','".$seq."','".$x."',0,'".$precio."','".$iva."',0,'UND',1,'".$stock_real."',0,'".$descuen."')";
					...
					VALUES(1,1,'".$consecutivo."','".$id."',convert(varchar,(select id from documentos_lin_ped where bodega=1 and sw=1 and numero= '".$consecutivo."' and codigo='".$id."')),'".$seq."','".$x."',0,'".$precio."','".$iva."',0,'UND',1,'".$stock_real."',0,'".$descuen."')";
					...
					if ($pomo['codigo']!=""){
						...
						$sql14 = "SELECT r.Codigo,convert(varchar,r.porcentaje_iva) as iva, convert(varchar,r.valor_unitario*(1 - r.factor_venta_".$lista.")) as Precio_Uni FROM referencias r WHERE  r.codigo = '".$codb."' and ref_anulada='N'";
					...
					//--------------------------------------------------------------------------
						...
						if($stock_dis>0){
							...
							if($C_bonificacion>0){
								...
								VALUES(1,1,'".$consecutivo."','".$id."','".$seq."','".$C_bonificacion."',0,'".$precio."','".$iva."',0,'UND',1,'".$C_bonificacion."',0,'".$descuen."')";
								...
								VALUES(1,1,'".$consecutivo."','".$id."',convert(varchar,(select id from documentos_lin_ped where bodega=1 and sw=1 and numero= '".$consecutivo."' and codigo='".$id."')),'".$seq."','".$C_bonificacion."',0,'".$precio."','".$iva."',0,'UND',1,'".$C_bonificacion."',0,'".$descuen."')";
			...
			$sql10 = "insert into documentos_lin_ped (sw,bodega,numero,codigo,seq,cantidad,cantidad_despachada,valor_unitario,porcentaje_iva,porcentaje_descuento,und,cantidad_und,despacho_virtual,porc_dcto_2,porc_dcto_3)
					VALUES(1,1,'".$consecutivo."','999000','".$seq."','2',0,'0','0',0,'UND',1,'2',0,'0')";
			...
			$sql11 = "insert into documentos_lin_ped_historia (sw,bodega,numero,codigo,id,seq,cantidad,cantidad_despachada,valor_unitario,porcentaje_iva,porcentaje_descuento,und,cantidad_und,despacho_virtual,porc_dcto_2,porc_dcto_3)
				VALUES(1,1,'".$consecutivo."','999000',convert(varchar,(select id from documentos_lin_ped where bodega=1 and sw=1 and numero= '".$consecutivo."' and codigo='999000')),'".$seq."','2',0,'0','0',0,'UND',1,'2',0,'0')";
...
<table width="50%" border="0">
  <tr>
     <td class="tituloPagina" colspan="3" scope="col"><h2>Pedido Generada Numero:<?php echo $consecutivo; ?></h2></td>
     </tr>
  <tr>
